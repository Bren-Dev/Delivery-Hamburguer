        ...
        <SectionFood>
          <DivOffer>
            ...
            <div>
              ...
              <DivPrice>
                <span className="Price">R${((price + (queijoCheddar*4.99) + (crispy*1.50) + (molhoCheddar*3.50)+(picanha*3.50))*state).toFixed(2).replace(".",",")}</span>
                <span className="Discount">R${((discount + (queijoCheddar*4.99) + (crispy*1.50) + (molhoCheddar*3.50)+(picanha*3.50))*state).toFixed(2).replace(".",",")}</span>
              </DivPrice>
            </div>
          </DivOffer>
        </SectionFood>
